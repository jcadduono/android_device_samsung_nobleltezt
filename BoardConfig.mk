...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --board FPRPNLCC000
...
TARGET_PREBUILT_KERNEL := device/samsung/nobleltezt/Image
TARGET_PREBUILT_DTB := device/samsung/nobleltezt/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/nobleltezt/bootimg.mk
...
TARGET_LIBINIT_DEFINES_FILE := device/samsung/nobleltezt/init/init_nobleltezt.cpp
